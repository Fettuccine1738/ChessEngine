...
public class PESTO implements Evaluator {
    ...
    final static int[] MID_GAME_VAL =   { 82, 337, 365, 477, 1025, 0};
    final static int[] END_GAME_VAL    =   { 94, 281, 297, 512,  936,  0};

    final static int[] PAWN_MID_GAME = {
            0,   0,   0,   0,   0,   0,  0,   0,
    ...
    final static int[] PAWN_END_GAME = {
            0,   0,   0,   0,   0,   0,   0,   0,
    ...
    final static int[] KNIGHT_MID_GAME = {
    ...
    final static int[] KNIGHT_END_GAME = {
    ...
    final static int[] BISHOP_MID_GAME = {
    ...
    final static int[] BISHOP_END_GAME = {
    ...
    final static int[] ROOK_MID_GAME = {
    ...
    final static int[] ROOK_END_GAME = {
    ...
    final static int[] QUEEN_MID_GAME = {
    ...
    final static int[] QUEEN_END_GAME = {
    ...
    final static int[] KING_MID_GAME = {
    ...
    final static int[] KING_END_GAME = {
